              ...
              >
                {socialLoading === "apple" ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-sm">Log In with Apple</span>
                  </>
                )}
              </button>
              ...
              >
                {socialLoading === "google" ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-sm text-gray-800">Log in with Google</span>
                  </>
                )}
              </button>
              ...
              >
                {socialLoading === "facebook" ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-sm text-white">Log In with Facebook</span>
                  </>
                )}
              </button>
            </div>
