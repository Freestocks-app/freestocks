...
export default function SignInPage() {
  ...
  async function handleSocialSignIn(provider: "google" | "apple" | "facebook") {
    ...
    try {
      ...
      if (result?.error) {
        setError(result.error.message || `${provider.charAt(0).toUpperCase() + provider.slice(1)} sign in failed.`);
      ...
      <main className="flex-1 flex items-center justify-center p-4 py-6 sm:py-8">
        <div className="w-full max-w-[380px]">
          <div className="card p-4 sm:p-6 border-border/50 bg-elevated/80 backdrop-blur-sm">
            <h1 className="text-lg sm:text-xl font-bold text-center mb-5 sm:mb-6">Log In</h1>
              ...
              >
                {socialLoading === "apple" ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-xs sm:text-sm">Log In with Apple</span>
                  </>
                )}
              </button>
              ...
              >
                {socialLoading === "google" ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-xs sm:text-sm text-gray-800">Log in with Google</span>
                  </>
                )}
              </button>
              ...
              >
                {socialLoading === "facebook" ? (
                  ...
                  <>
                    ...
                    <span className="font-medium text-xs sm:text-sm text-white">Log In with Facebook</span>
                  </>
                )}
              </button>
            </div>
            ...
            <p className="text-center text-xs sm:text-sm text-muted mt-4 sm:mt-5">
              ...
              <Link href="/sign-up" className="text-cta hover:underline font-medium">
                Sign up
              </Link>
            </p>
          </div>
